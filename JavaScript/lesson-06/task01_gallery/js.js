...
const gallery = {
  settings: {
    ...
    openedImageNotFoundSrc: 'images/gallery/not_found.jpg'
  },
   ...
   */
  openImage(src) {
    src = src || this.settings.openedImageNotFoundSrc;
  ...
  createScreenContainer() {
    ...
    image.addEventListener("error", evt => this.onErrorLoadImage(evt));
  ...
  /**
   * Обрабатывает событие ошибки при загрузке изображения.
   * @param {Event} evt 
   */
  onErrorLoadImage(evt) {
    evt.target.src = this.settings.openedImageNotFoundSrc;
  }
};
